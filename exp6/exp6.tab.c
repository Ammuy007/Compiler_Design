...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from exp6.y  */
...
const int YY_parse_CLASS::alpha=258;
const int YY_parse_CLASS::numeric=259;
...
static const char * const yytname[] = {   "$","error","$illegal.","alpha","numeric",
"'\\n'","start","S","A",""
};
#endif
